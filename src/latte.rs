...
// sha256: 819eb86c6cee49e8a87d769037de115f2677e223b2a15d616917b93c736c8d41
use std::str::FromStr;
use crate::ast::*;
...
mod __parse__GBoolean {
    ...
    pub enum __Symbol<'input>
     {
        ...
        Variant2(IntLit),
        Variant3(StrLit),
        Variant4(::std::option::Option<&'input str>),
    }
    ...
    pub struct GBooleanParser {
        builder: super::__intern_token::__MatcherBuilder,
        _priv: (),
    }

    impl GBooleanParser {
        pub fn new() -> GBooleanParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<BoolLit, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
    ...
    >(
        ...
        _: ::std::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<BoolLit,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            ...
            5 => {
                // __GBoolean = GBoolean => ActionFn(1);
    ...
    {
        // __GInteger = GInteger => ActionFn(0);
...
pub use self::__parse__GBoolean::GBooleanParser;

#[cfg_attr(rustfmt, rustfmt_skip)]
mod __parse__GInteger {
    #![allow(non_snake_case, non_camel_case_types, unused_mut, unused_variables, unused_imports, unused_parens)]
    ...
    pub struct GIntegerParser {
        builder: super::__intern_token::__MatcherBuilder,
        _priv: (),
    }

    impl GIntegerParser {
        pub fn new() -> GIntegerParser {
            let __builder = super::__intern_token::__MatcherBuilder::new();
            GIntegerParser {
                builder: __builder,
                _priv: (),
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<IntLit, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
            let mut __tokens = self.builder.matcher(input);
            let __r = __state_machine::Parser::drive(
                __StateMachine {
    ...
    >(
        ...
        __symbols: &mut ::std::vec::Vec<(usize,__Symbol<'input>,usize)>,
        _: ::std::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<IntLit,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            0 => {
                __reduce0(input, __action, __lookahead_start, __states, __symbols, ::std::marker::PhantomData::<(&())>)
...
pub use self::__parse__GInteger::GIntegerParser;

#[cfg_attr(rustfmt, rustfmt_skip)]
mod __parse__GString {
    #![allow(non_snake_case, non_camel_case_types, unused_mut, unused_variables, unused_imports, unused_parens)]
    ...
    pub struct GStringParser {
        builder: super::__intern_token::__MatcherBuilder,
        _priv: (),
    }

    impl GStringParser {
        pub fn new() -> GStringParser {
            let __builder = super::__intern_token::__MatcherBuilder::new();
            GStringParser {
                builder: __builder,
                _priv: (),
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<StrLit, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
            let mut __tokens = self.builder.matcher(input);
            let __r = __state_machine::Parser::drive(
                __StateMachine {
    ...
    >(
        ...
        __symbols: &mut ::std::vec::Vec<(usize,__Symbol<'input>,usize)>,
        _: ::std::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<StrLit,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            0 => {
                __reduce0(input, __action, __lookahead_start, __states, __symbols, ::std::marker::PhantomData::<(&())>)
...
pub use self::__parse__GString::GStringParser;
#[cfg_attr(rustfmt, rustfmt_skip)]
mod __intern_token {
    #![allow(unused_imports)]
    use std::str::FromStr;
...
>(
    input: &'input str,
    (_, s, _): (usize, ::std::option::Option<&'input str>, usize),
