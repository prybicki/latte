...
@str_lit = global [3 x i8] c"&&\00"
@str_lit.1 = global [3 x i8] c"||\00"
@str_lit.2 = global [2 x i8] c"!\00"
@str_lit.3 = global [6 x i8] c"false\00"
@str_lit.4 = global [5 x i8] c"true\00"
...
define i32 @main() {
entry:
  call void @printString(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @str_lit, i32 0, i32 0))
  %0 = call i1 @test(i32 -1)
  br i1 %0, label %lazy_eval_and_lhs_true, label %lazy_eval_and_done

lazy_eval_and_lhs_true:                           ; preds = %entry
  %1 = call i1 @test(i32 0)
...
lazy_eval_and_done2:                              ; preds = %lazy_eval_and_lhs_true1, %lazy_eval_and_done
  ...
  call void @printBool(i1 %lazy_eval_and_result3)
  %4 = call i1 @test(i32 3)
  br i1 %4, label %lazy_eval_and_lhs_true4, label %lazy_eval_and_done5

lazy_eval_and_lhs_true4:                          ; preds = %lazy_eval_and_done2
  %5 = call i1 @test(i32 -5)
  br label %lazy_eval_and_done5

lazy_eval_and_done5:                              ; preds = %lazy_eval_and_lhs_true4, %lazy_eval_and_done2
  %lazy_eval_and_result6 = phi i1 [ false, %lazy_eval_and_done2 ], [ %5, %lazy_eval_and_lhs_true4 ]
  call void @printBool(i1 %lazy_eval_and_result6)
  %6 = call i1 @test(i32 234234)
  br i1 %6, label %lazy_eval_and_lhs_true7, label %lazy_eval_and_done8

lazy_eval_and_lhs_true7:                          ; preds = %lazy_eval_and_done5
  %7 = call i1 @test(i32 21321)
  br label %lazy_eval_and_done8

lazy_eval_and_done8:                              ; preds = %lazy_eval_and_lhs_true7, %lazy_eval_and_done5
  %lazy_eval_and_result9 = phi i1 [ false, %lazy_eval_and_done5 ], [ %7, %lazy_eval_and_lhs_true7 ]
  call void @printBool(i1 %lazy_eval_and_result9)
  call void @printString(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @str_lit.1, i32 0, i32 0))
  %8 = call i1 @test(i32 -1)
  br i1 %8, label %lazy_eval_or_done, label %lazy_eval_or_lhs_false

lazy_eval_or_lhs_false:                           ; preds = %lazy_eval_and_done8
  %9 = call i1 @test(i32 0)
  br label %lazy_eval_or_done

lazy_eval_or_done:                                ; preds = %lazy_eval_or_lhs_false, %lazy_eval_and_done8
  %lazy_eval_or_result = phi i1 [ true, %lazy_eval_and_done8 ], [ %9, %lazy_eval_or_lhs_false ]
  call void @printBool(i1 %lazy_eval_or_result)
  %10 = call i1 @test(i32 -2)
  br i1 %10, label %lazy_eval_or_done11, label %lazy_eval_or_lhs_false10

lazy_eval_or_lhs_false10:                         ; preds = %lazy_eval_or_done
  %11 = call i1 @test(i32 1)
  br label %lazy_eval_or_done11

lazy_eval_or_done11:                              ; preds = %lazy_eval_or_lhs_false10, %lazy_eval_or_done
  %lazy_eval_or_result12 = phi i1 [ true, %lazy_eval_or_done ], [ %11, %lazy_eval_or_lhs_false10 ]
  call void @printBool(i1 %lazy_eval_or_result12)
  %12 = call i1 @test(i32 3)
  br i1 %12, label %lazy_eval_or_done14, label %lazy_eval_or_lhs_false13

lazy_eval_or_lhs_false13:                         ; preds = %lazy_eval_or_done11
  %13 = call i1 @test(i32 -5)
  br label %lazy_eval_or_done14

lazy_eval_or_done14:                              ; preds = %lazy_eval_or_lhs_false13, %lazy_eval_or_done11
  %lazy_eval_or_result15 = phi i1 [ true, %lazy_eval_or_done11 ], [ %13, %lazy_eval_or_lhs_false13 ]
  call void @printBool(i1 %lazy_eval_or_result15)
  %14 = call i1 @test(i32 234234)
  br i1 %14, label %lazy_eval_or_done17, label %lazy_eval_or_lhs_false16

lazy_eval_or_lhs_false16:                         ; preds = %lazy_eval_or_done14
  %15 = call i1 @test(i32 21321)
  br label %lazy_eval_or_done17

lazy_eval_or_done17:                              ; preds = %lazy_eval_or_lhs_false16, %lazy_eval_or_done14
  %lazy_eval_or_result18 = phi i1 [ true, %lazy_eval_or_done14 ], [ %15, %lazy_eval_or_lhs_false16 ]
  call void @printBool(i1 %lazy_eval_or_result18)
  call void @printString(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str_lit.2, i32 0, i32 0))
...
then:                                             ; preds = %entry
  call void @printString(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str_lit.3, i32 0, i32 0))
  br label %cont

cont:                                             ; preds = %else, %then
  %b = phi i1 [ %0, %then ], [ %0, %else ]
  ret void

else:                                             ; preds = %entry
  call void @printString(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str_lit.4, i32 0, i32 0))
  br label %cont
}
