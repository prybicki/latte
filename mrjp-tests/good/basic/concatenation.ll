...
@str_lit = global [2 x i8] c"a\00"
@str_lit.1 = global [2 x i8] c"b\00"
...
define i32 @main() {
entry:
  %0 = call i8* @__latc_concat_str(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str_lit, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str_lit.1, i32 0, i32 0))
