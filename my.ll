...
define i32 @main() {
entry:
  br i1 false, label %and_right, label %or_right

then:                                             ; preds = %and_right1, %and_right
  call void @printString(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str_lit, i32 0, i32 0))
  br label %cont

cont:                                             ; preds = %then, %and_right1, %or_right
  %a = phi i1 [ false, %entry ], [ false, %then ]
  %b = phi i1 [ true, %entry ], [ true, %then ]
  ret i32 0

or_right:                                         ; preds = %and_right, %entry
  br i1 false, label %and_right1, label %cont

and_right:                                        ; preds = %entry
  br i1 true, label %then, label %or_right

and_right1:                                       ; preds = %or_right
  br i1 true, label %then, label %cont
}
